...
// Simply illustrates how to use the factory
public class KafkaSubscriberProtobufFactoryTest implements EventReceivedCallback<FrameworkTest.Foobar> {
    ...
    @Override
    public void eventReceived(FrameworkTest.Foobar message, KafkaTopicInfo topicInfo) {
