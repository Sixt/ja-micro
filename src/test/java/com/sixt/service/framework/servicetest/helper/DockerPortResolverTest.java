...
public class DockerPortResolverTest {

    private DockerPortResolver portResolver = new DockerPortResolver(mock(ProcessUtil.class));

    @Test
    public void parseExposedPortTest() {
        String json = "[{\"NetworkSettings\": {\"Ports\": {\"5005/tcp\": " +
                "[{\"HostIp\": \"0.0.0.0\",\"HostPort\": \"33240\"}]}}}]";
        int result = portResolver.parseExposedPort(json, 5005);
